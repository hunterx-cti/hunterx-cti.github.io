---
layout: default
title: HunterX Threat Intelligence Lab
---
...
- [About the Analyst](about.md)  
- [Threat Reports](threat-reports.md)  
- [Malware Analysis](malware-analysis.md)  
- [OSINT Investigations](osint.md)  
...
Analyze an Android spyware distribution campaign via SMS.  
*(Read more in [Threat Reports](threat-reports.md))*

### Banking Phishing Infrastructure Analysis
Explore the domains, servers, and tactics used in banking-targeted attacks.  
*(Read more in [Threat Reports](threat-reports.md))*

### Building a Python Tool to Detect Malicious Links
Learn how to automate threat intelligence collection and link analysis.  
*(Read more in [Tools](tools.md))*
